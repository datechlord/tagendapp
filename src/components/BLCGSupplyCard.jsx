...
export default function BLCGSupplyCard() {

       const address = useAddress();
       const { contract: 
        blcgContract, 
        isLoading: loadingblcgToken } = useContract(BLCG_CONTRACT_ADDRESSES);
        
        const {
          data: tokenSupply,
          isLoading:tokenSupplyisLoading,
       } = useTokenSupply(blcgContract)
    ...
    <Section>
      <div className="analytic">
        <div className="content">
          <h5>BLCG Supply</h5>
          <h2
          isLoaded={!tokenSupplyisLoading}
          >{tokenSupply?.displayValue} {tokenSupply?.symbol}</h2>
        </div>
        <div className="logo">
