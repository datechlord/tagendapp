...
import { useAddress, useClaimedNFTSupply, useContract, useTokenBalance, useTokenSupply, useTotalCount } from "@thirdweb-dev/react";
import { ERC721_CONTRACT_ADDRESS } from "../const/addresses";


export default function NFTClaimedCard() {
